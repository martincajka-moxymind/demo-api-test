...
module.exports = {
  forbidden: [
    /*
     * RULE: Disallow dependencies on a specific library (e.g., migrating away from moment.js).
     * WHY: Enforces technical decisions and prevents old libraries from creeping back in.
     */
    {
      name: "no-momentjs",
      severity: "error",
...
// generated: dependency-cruiser@17.0.1 on 2025-10-02T11:03:44.726Z
